...
export const breakepadRepairService = {
    ...
    metaDescription: "Brake pads worn out? Get expert brake pad replacement and inspection in Dubai. Fast mobile service, emergency brake repair, and quality parts to ensure safe driving.",
    ...
    intro: {
        ...
        content: "Brake pads are critical for your safety. Worn-out brake pads can cause squeaking, reduced braking efficiency, or even dangerous accidents. Our expert brake pad repair service in Dubai provides fast mobile service, thorough inspection, and quality replacements to ensure your car stops safely and smoothly."
    },

    whyChooseUs: {
        heading: "Why Choose Our Brake Pad Repair Service in Dubai?",
        points: [
            "24/7 mobile brake repair service across Dubai",
    ...
    ctaSection: {
        ...
        description: "Call now for fast, reliable brake pad replacement and mobile brake service anywhere in Dubai. Ensure your car stops safely every time.",
