...
export const emergancyCarRepairService = {
    ...
    metaDescription: "Stuck on the road in Dubai? Our 24/7 emergency car repair service provides fast, professional mobile mechanics at your location. Battery, starter, AC, brakes, and full car repair solutions.",
    ...
    intro: {
        ...
        content: "Our Dubai-based emergency car repair service gets you back on the road quickly. Whether your car won’t start, battery is dead, brakes fail, or engine has issues, our expert mechanics come to your location and fix it onsite. We provide fast, reliable, and affordable emergency car repair throughout Dubai."
    },

    whyChooseUs: {
        heading: "Why Choose Our Emergency Car Repair Service?",
        points: [
            "Immediate response across Dubai 24/7",
        ...
        steps: [
            {
                ...
                description: "Contact us via call or WhatsApp and our mechanic reaches your location ASAP."
            },
            {
    ...
    ctaSection: {
        ...
        description: "Fast 24/7 roadside car repair service. Get your car fixed by certified mechanics anywhere in Dubai.",
    ...
    faq: [
        {
            ...
            answer: "Our emergency mechanics typically reach within 15–45 minutes depending on traffic and your location."
        },
        {
