...
export const transmissionRepairService = {
    ...
    metaDescription: "Stuck in gear or facing transmission issues? Our Dubai-based car mechanics provide fast and reliable transmission repair, clutch and gearbox maintenance at your location.",
    ...
    intro: {
        ...
        subheading: "Ensure Smooth Gear Shifts & Reliable Driving",
        content: "Our expert mobile mechanics in Dubai provide complete transmission repair services for both automatic and manual vehicles. From clutch issues to gearbox problems, we diagnose and repair transmission faults onsite, so you get back on the road safely and quickly."
    },

    whyChooseUs: {
        heading: "Why Choose Our Transmission Repair Service?",
        points: [
    ...
    ctaSection: {
        ...
        description: "Fast, reliable onsite transmission repair by certified mechanics anywhere in Dubai. Restore smooth gear shifts today.",
