...
import { Phone, MessageCircle, ChevronUp, Facebook, Instagram, Youtube, MapPin, Settings, Calendar } from "lucide-react";
import Link from "next/link";
import { useState, useEffect } from "react";
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg md:hidden">
        <div className="flex h-16">
          ...
          <Link
            ...
            className="flex-1 flex flex-col items-center justify-center text-gray-600 transition-colors"
          >
            <div className="bg-rose-500 p-2 rounded-full mb-1">
          ...
          {/* <Link
            href="/dubai/services"
            className="flex-1 flex flex-col items-center justify-center text-blue-600 hover:bg-blue-50 transition-colors"
          >
          ...
          <Link
            ...
            className="flex-1 flex flex-col items-center justify-center text-gray-600 transition-colors"
          >
            <div className="bg-purple-500 p-2 rounded-full mb-1">
          ...
          <Link
            ...
            className="flex-1 flex flex-col items-center justify-center text-gray-600 hover:bg-primary/5 transition-colors"
          >
          ...
          <Link
            href={numberCallLink}
            className="flex-1 flex flex-col items-center justify-center text-gray-600 hover:bg-blue-50 transition-colors"
          >
          ...
          <Link
            ...
            className="flex-1 flex flex-col items-center justify-center text-gray-600 hover:bg-[#25D366]/5 transition-colors"
          >
