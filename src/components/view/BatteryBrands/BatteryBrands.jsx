...
//   const batteryBrands = [
//     { name: "Amaron", origin: "India",  description: "Premium automotive batteries" },
//     { name: "Varta", origin: "Germany",  description: "German engineering excellence" },
//     { name: "Bosch", origin: "Germany",  description: "World-leading technology" },
//     { name: "ACDelco", origin: "USA",  description: "American reliability" },
//     { name: "Optima", origin: "USA",  description: "Spiral cell technology" },
//     { name: "Solite", origin: "Korea",  description: "Value performance" },
//     { name: "Delkor", origin: "Korea",  description: "Premium Korean quality" },
//     { name: "Rocket", origin: "Korea",  description: "Reliable everyday choice" },
//     { name: "Panasonic", origin: "Japan",  description: "Japanese precision" },
//     { name: "Exide", origin: "India",  description: "Global power leader" },
//     { name: "Odyssey", origin: "USA",  description: "Extreme performance" },
//     { name: "GS Yuasa", origin: "Japan",  description: "Japanese technology" },
//     { name: "Hankook", origin: "Korea",  description: "Korean innovation" },
//     { name: "Kays", origin: "UAE",  description: "Local trusted brand" },
//     { name: "Zeetex", origin: "Germany",  description: "German value" },
//     { name: "Duracell", origin: "USA",  description: "Trusted power" },
//     { name: "Energizer", origin: "USA",  description: "Long-lasting energy" },
//     { name: "Furukawa Battery", origin: "Japan",  description: "Japanese expertise" },
//     { name: "Global", origin: "UAE",  description: "Regional favorite" },
//     { name: "Eveready", origin: "USA",  description: "Household name" },
//   ];
...
//         {/* Brands Carousel - Similar to Reviews */}
...
//                   {/* Premium Badge */}
//                   {brand.premium && (
//                     <div className="absolute top-3 right-3 bg-linear-to-r from-primary to-primary/80 text-white px-2 py-0.5 rounded-full text-[9px] font-bold z-10">
//                       PREMIUM
//                     </div>
//                   )}
...
//                     {/* Brand Icon */}
//                     <div className={`w-12 h-12 mx-auto rounded-full flex items-center justify-center mb-3 ${brand.premium ? 'bg-primary/10' : 'bg-gray-100'}`}>
//                       {brand.premium ? (
...
//           <Link
//             href="/dubai/batteries"
//             className="inline-flex items-center gap-2 bg-primary text-white font-semibold px-6 py-2.5 rounded-full text-sm shadow-md"
//           >
//             View All Brands
...
// // Import ArrowRight if not already available
